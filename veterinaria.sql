...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2022 a las 06:43:22
...
(5, 123, 'Tamara', 'Abarza', 2664340080, 'Quinto centenario', 2665456789, 1),
(6, 41566432, 'Luciano', 'Cejas', 2664534322, 'falucho 543', 2665456780, 1),
...
(6, 'Luna', 'hembra', 'gato', 'siames', 'blanco', '2015-01-21', 7, 1);
...
(3, 'se aplicó la vacuna parainfluenza canina', 'Nobivac', 1600, 'vacunación', 1),
...
(10, 4, '2021-10-20', 'no presenta síntomas', 23, 3, 1),
(11, 5, '2022-04-15', 'no presenta síntomas', 12, 3, 1),
(14, 4, '2022-05-07', 'adelgazamiento', 20, 4, 0);
